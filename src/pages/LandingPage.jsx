...
>
  ...
  <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-20 px-6">
    ...
    >
      ...
      >
        A premier scholarly journal, established in 2025, dedicated to advancing interdisciplinary research
...
>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6">
    ...
    >
      <motion.h2
        className="text-5xl lg:text-5xl font-serif font-bold text-white mb-6"
        variants={fadeInUp}
      >
        Journal Resources 
      </motion.h2>
      <motion.p
        className="text-2xl text-white max-w-3xl mx-auto font-semibold"
        variants={fadeInUp}
      >
        {/* Access comprehensive information about our journal, submission
        guidelines, and scholarly resources */}
        Explore key details about publishing policies, editorial board, and ISSN registration.
      </motion.p>
    </motion.div>
